...
//						 Allow access to all employees without authentication
						...
						.requestMatchers(HttpMethod.GET, "/api/MerchantDeviceAssociation/get/merchantdeviceslist")
						.hasRole("admin")
						.requestMatchers(HttpMethod.GET, "/api/MerchantDeviceAssociation/check/merchant-device")
						.hasRole("admin").requestMatchers(HttpMethod.GET, "/api/feedback/allfeedbackscount")
						.hasRole("admin").requestMatchers(HttpMethod.GET, "/api/feedback/average-rating-by-device")
						.hasRole("admin").requestMatchers(HttpMethod.GET, "/api/MerchantDeviceAssociation/device-count")
						.hasRole("admin").requestMatchers(HttpMethod.GET, "/api/feedback/device-count").hasRole("admin")
