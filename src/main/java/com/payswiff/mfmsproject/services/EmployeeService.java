...
public class EmployeeService {
	...
	/**
	 * Saves a new Employee after checking if an employee with the same Payswiff ID,
	...
	public Employee saveEmployee(Employee employee)
		...
		employee.setEmployeePassword(passwordEncoder.encode(password)); // Encode and set the password
		...
		emailSendDto.setText("Your Account has been created successfully.\n" + "Your Login Credentials are:\n"
				+ "Email: " + employee.getEmployeeEmail() + "\n" + "Password: " + password); // Use raw password for the
																								// email
	 ...
	 * @throws ResourceNotFoundException If no employee is found with the provided
	 *                                   details.
	 */
